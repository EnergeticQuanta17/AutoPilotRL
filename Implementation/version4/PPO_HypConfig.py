...
class PolicySelector:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("policy", ["MlpPolicy"])  ##, "CnnPolicy", "MultiInputPolicy"
...
class StepsPerUpdate:
    ...
    def opt(self, trial):
        return 2 ** trial.suggest_int("n_steps", 1, 11)
...
class BatchSize:
    ...
    def opt(self, trial):
        return  2 ** trial.suggest_int("batch_size", 1, 6)
...
class NoOfEpochs:
    ...
    def opt(self, trial):
        return trial.suggest_int("n_epochs", 1, 10)
...
class DiscountFactor:
    ...
    def opt(self, trial):
        return trial.suggest_float("gamma", 0, 1)
...
class BiasVarianceTradeoff:
    ...
    def opt(self, trial):
        return trial.suggest_float("bvtradeoff", 0, 1)
...
class ClipRange:
    ...
    def opt(self, trial):
        return trial.suggest_float("clip_range", 0, 1)
...
class ClipRangeVF:
    ...
    def opt(self, trial):
        return trial.suggest_float("clip_range_vf", 0, 1)
...
class NormalizeAdvantage:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("normalize_advantage", [False])
...
class EntropyCoefficient:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("ent_coef", [0])
...
class ValueFunctionCoefficient:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("vf_coef", [0.5])
...
class MaxGradNorm:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("max_grad_norm", [0.5])
...
class BoolGeneralizedStateDependentExploration:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("use_sde", [False])
...
class SDESampleFrequency:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("sde_sample_freq", [-1])
...
class TargetKL:
    ...
    def opt(self, trial):
        return trial.suggest_categorical("target_kl", [None])
